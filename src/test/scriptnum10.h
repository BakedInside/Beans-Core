...
#ifndef BEANS_TEST_SCRIPTNUM10_H
#define BEANS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Beans Core 0.10.0, for cross-comparison.
 */
public:
