...
static constexpr int64_t STALE_CHECK_INTERVAL = 3600 * 24 * 365; // 10 minutes this was changed on setup -sean
...
static constexpr int STALE_RELAY_AGE_LIMIT = 3600 * 24 * 365; //this was also changed -sean
