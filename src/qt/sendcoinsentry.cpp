    ...
    platformStyle(_platformStyle)
{
    ...
    // normal beans address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying beans address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BeansAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
