...
//! Entry point for BeansApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BeansApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BeansGUI tests.
void AppTests::guiTests(BeansGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BeansGUI::consoleShown, this, &AppTests::consoleTests);
