...
#ifndef BEANS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BEANS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BEANS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
