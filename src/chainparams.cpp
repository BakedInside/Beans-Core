...
{
    const char* pszTimestamp = "05/06/21 Bidens 80 billion dollar plan to beef up IRS audits";
...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0x000000002bea1feb844e81ad46cdce168fab0525b77dd6f9f75cf58a22ab27e0");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x000000002bea1feb844e81ad46cdce168fab0525b77dd6f9f75cf58a22ab27e0");
        ...
        consensus.nPowTargetTimespan = 1 * 60 * 60; // 1 hour block diff
        consensus.nPowTargetSpacing = 2.5 * 60; //2.5 min block time
        ...
        consensus.defaultAssumeValid = uint256S("0x000000002bea1feb844e81ad46cdce168fab0525b77dd6f9f75cf58a22ab27e0"); // 654683
        ...
        genesis = CreateGenesisBlock(1620365725, 1745234661, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000002bea1feb844e81ad46cdce168fab0525b77dd6f9f75cf58a22ab27e0"));
        assert(genesis.hashMerkleRoot == uint256S("0x8708f8968479922d91041c73d959094a31b95463e4660df734434e1a19888834"));
