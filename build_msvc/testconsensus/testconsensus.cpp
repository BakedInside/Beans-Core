...
// beans includes.
#include <..\src\script\beansconsensus.h>
...
int main()
{
    std::cout << "beansconsensus version: " << beansconsensus_version() << std::endl;
    ...
    auto op0Result = beansconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, beansconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
