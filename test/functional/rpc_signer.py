...
Verify that a beansd node can use an external signer command.
...
class RPCSignerTest(BeansTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart beansd with -signer=<cmd>',
