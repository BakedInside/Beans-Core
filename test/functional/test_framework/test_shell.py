...
class TestShell:
    """Wrapper Class for BeansTestFramework.

    The TestShell class extends the BeansTestFramework
    ...
    class __TestShell(BeansTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BeansTestFramework child class.
            self.num_nodes = 1
