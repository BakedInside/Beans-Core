...
def main(args):
    ...
    if not success:
        print("beans.org failed to provide signature file, "
              "but beanscore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("beans.org and beanscore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Beans Core binary release "
