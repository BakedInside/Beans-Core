...
This document provides guidelines for internationalization of the Beans Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `beans_en.ts` remains unchanged.
