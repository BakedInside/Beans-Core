Beans Core version 0.9.4 is now available from:

  https://beans.org/bin/0.9.4/
...
this update is incompatible with the Beans system and could lead to consensus
forks.

Beans Core released binaries from https://beans.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~beans/+archive/ubuntu/beans
- A third-party or self-compiled Beans Core

upgrade to Beans Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
