Beans version 0.5.4 is now available for download at:
http://sourceforge.net/projects/beans/files/Beans/beans-0.5.4/
...
http://gitorious.org/beans/beansd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Beans-Qt notifications under Growl 1.3.
Increase required age of Beans-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBeans properly when installing Beans-Qt over it. (Windows)
