Beans-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/beans/files/Beans/beans-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Beans
...
New/changed settings (command-line or beans.conf file)
--------------------------------------------------------
