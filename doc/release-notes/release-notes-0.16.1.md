Beans Core version 0.16.1 is now available from:

  <https://beanscore.org/bin/beans-core-0.16.1/>
...
- #12843 `df38b13` Test starting beansd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure beansd processes are cleaned up when tests end (sdaftuar)
