Beans Core version 0.10.4 is now available from:

  <https://beans.org/bin/beans-core-0.10.4/>
...
- #6953 `43c2789` Split beans-tx into its own package
- #6953 `dfe0d4d` Include beans-tx binary on Debian/Ubuntu
