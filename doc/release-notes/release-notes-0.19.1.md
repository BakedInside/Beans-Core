...
Beans Core version 0.19.1 is now available from:

  <https://beanscore.org/bin/beans-core-0.19.1/>
...
From Beans Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Beans Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Beans Core does not yet change appearance when
...
- #17488 fix "beansd already running" warnings on macOS (fanquake)
