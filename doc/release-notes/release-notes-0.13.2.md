Beans Core version 0.13.2 is now available from:

  <https://beans.org/bin/beans-core-0.13.2/>
...
- #8908 `4a974b2` Update beans-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow beans-tx to create v2 transactions (btcdrak)
