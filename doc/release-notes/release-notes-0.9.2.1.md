Beans Core version 0.9.2.1 is now available from:

  https://beans.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BNS to 0.01 BNS
...
- Fix "Start beans on system login"
