Beans Core version *0.15.2* is now available from:

  <https://beanscore.org/bin/beans-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in beans-tx (TheBlueMatt)
