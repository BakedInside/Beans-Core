Contributing to Beans Core
============================

The Beans Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Beans Core build
system and tests. Refer to the documentation in the repository on how to build
Beans Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/beans/beans/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/beans/beans/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Beans Core PR Review Club](https://beanscore.reviews/) meeting.
...
Most communication about Beans Core development happens on IRC, in the
`#beans-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/beans-core-dev/](http://www.erisian.com.au/beans-core-dev/)
and [http://gnusha.org/beans-core-dev/](http://gnusha.org/beans-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/beans-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to beans-qt
...
fork of Beans Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/beans/beans/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Beans Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Beans
Network Protocol consensus changes.

Whether a pull request is merged into Beans Core rests with the project merge
...
Patches that change Beans consensus rules are considerably more involved than
...
Where a patch set proposes to change the Beans consensus, it must have been
...
https://github.com/beans/beans/pull/16189).

Also see the [backport.py script](
https://github.com/beans-core/beans-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Beans Core release.
